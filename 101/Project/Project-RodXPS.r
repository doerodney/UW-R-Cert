...
boxplot(lmfit, notch=TRUE, xlab="Home time zone - Visitor time zone", ylab="Home team goal differential", main="Effect of time zone difference on home team goal differential")
...
# Effect of upon average home stadium capacity upon home goal differential
...
# Stadium capacity effect size
summary.lm(aov(mls$HomeGoalDiff ~ mls$HomeTeamCapacity))

# Effect of upon average home stadium utilization upon home goal differential
plot(mls$FractionFull, mls$HomeGoalDiff, main="Home team goal differential versus home team stadium utilization", 
xlab="Average home team stadium utilization", ylab="Home goal differential")
abline(lm(mls$HomeGoalDiff ~ mls$FractionFull))

# Average stadium utilization effect size
summary.lm(aov(mls$HomeGoalDiff ~ mls$FractionFull))

# Effect of home team salary upon home goal differential
plot(mls$HomeTeamSalary, mls$HomeGoalDiff, main="Home team goal differential versus home team salary", 
xlab="Team Salary", ylab="Home goal differential")
abline(lm(mls$HomeGoalDiff ~ mls$HomeTeamSalary))

# Average home team salary effect size
summary.lm(aov(mls$HomeGoalDiff ~ mls$HomeTeamSalary))
