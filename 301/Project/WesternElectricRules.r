setwd("C:/Users/Rod/SkyDrive/R/301/Project")
...
plotSpcChart <- function(batchAverages, batchRanges, x.bar.batchAverages = NULL, sigma.batchAverages = NULL, x.bar.batchRanges = NULL, sigma.batchRanges = NULL)
{
	...
	cols = c(rgb(0,1,0,0.6), rgb(1,0,0,0.6), rgb(1,0.6,0,0.6), rgb(0,0,1,0.6), rgb(1,0,1,0.6))
...
batchAverages = c(0, 0.1,0.2,0.1,  0.3,0.4,0.3, 0.4,0.5,0.4,   0,-0.1,0.25,  1.1,-1,1.1,1.2,1.1,   0,0.2,-0.4,  2.2,1.1,2.3,   -0.5,0,0.3,   4.1, -4.1)
