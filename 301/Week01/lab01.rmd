...
```{r q1viz,fig.width=6, fig.height=6,out.width='600px', out.height='600px',dpi=500}
curve(identity,xlab='1-Specificity (False Positive)',ylab='Sensitivity (True Positive)',main="ROC (Receiver-Operating-Characteristic) Curve")
...
```{r q1aids}
0.95*1e-4+0.01*0.9999
#And now the final answer:
0.95*1e-4/(0.95*1e-4+0.01*0.9999)
```
